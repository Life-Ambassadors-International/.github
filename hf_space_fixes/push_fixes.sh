...
echo ""
echo "=== Space 2: TEQUMSA-v60-MCP ==="
push_file "TEQUMSA-v60-MCP" "app.py"

echo ""
echo "=== Space 3: ALANARA-GAIA-Orchestrator ==="
push_file "ALANARA-GAIA-Orchestrator" "app.py"

echo ""
echo "=== Space 4: TEQUMSA-Constitutional-Validator ==="
